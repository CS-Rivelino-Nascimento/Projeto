class VendasController < ApplicationController
  ...
  private
    def selecionar_cliente
      @clientes_para_selecionar = Cliente.all
    end

    def selecionar_produto
      @produtos_para_selecionar = Produto.all
    end
    ...
    def venda_params
      params.require(:venda).permit(:quantidade, :valor, :data, :valor_unitario, :situacao, :Produto_id, :Cliente_id)
    end
end
