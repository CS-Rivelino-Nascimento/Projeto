...
class MateriaPrimasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materia_prima" do
    assert_difference('MateriaPrima.count') do
      post materia_primas_url, params: { materia_prima: { descricao: @materia_prima.descricao, valor: @materia_prima.valor } }
    end
  ...
  test "should update materia_prima" do
    patch materia_prima_url(@materia_prima), params: { materia_prima: { descricao: @materia_prima.descricao, valor: @materia_prima.valor } }
