...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { Materia_Prima_id: @despesa.Materia_Prima_id, data: @despesa.data, valor: @despesa.valor } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { Materia_Prima_id: @despesa.Materia_Prima_id, data: @despesa.data, valor: @despesa.valor } }
